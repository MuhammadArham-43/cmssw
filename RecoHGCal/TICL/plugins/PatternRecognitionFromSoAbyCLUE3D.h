#ifndef __RecoHGCal_TICL_PRFromSoAbyCLUE3D_H__
#define __RecoHGCal_TICL_PRFromSoAbyCLUE3D_H__
#include <memory>
...
namespace ticl {
    ...
    class PatternRecognitionFromSoAbyCLUE3D final : public PatternRecognitionAlgoBaseFromSoAT<TILES> {
        public:
            PatternRecognitionFromSoAbyCLUE3D(const edm::ParameterSet& conf, edm::ConsumesCollector);
            ~PatternRecognitionFromSoAbyCLUE3D() override = default;

            void makeTracksters(const typename
            PatternRecognitionAlgoBaseFromSoAT<TILES>::Inputs& input,
            std::vector<TracksterSoAHostCollection>& result,
